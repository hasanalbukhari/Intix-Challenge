...
- (void)startLoadingWitMessage:(NSString *)msg {
    [self animate];
...
- (void)stopLoadingWithError:(NSString *)msg {
...
- (void)stopLoadingWithErrorNoLocalization:(NSString *)msg {
    self.loadingBall.hidden = NO;
    self.loadingBall.userInteractionEnabled = YES;
    [self.loadingBall stopAnimating];
    [self setMessageTextNoLocalization:msg];
    reloadButton.hidden = NO;
    self.hidden = NO;
...
- (void)setMessageText:(NSString *)text {
    if (text == nil || [text isEqualToString:@""]) {
        ...
        self.messageLabel.text = message = [((Singlton *)[Singlton singlton]).languageDetails LocalString:text];
        self.messageLabel.hidden = NO;
    }
}

- (void)setMessageTextNoLocalization:(NSString *)text {
    if (text == nil || [text isEqualToString:@""]) {
        self.messageLabel.text = message = @"";
        self.messageLabel.hidden = YES;
    } else {
