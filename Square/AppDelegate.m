...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    DDLogVerbose(@"Name: %@", [[singlton userDetails] name]);
    DDLogVerbose(@"Code: %@", [[singlton userDetails] code]);
    
    // register for google maps
    [GMSServices provideAPIKey:@"AIzaSyBYAjlErxjNwi7MW_p8I8L_jT9umRW4tvg"];
